...
class TextDetection:
    ...
    def __init__(self, imagePath, minConfidence):
        ...
        self.rW = self.imageWidth / float(newW)
        self.rH = self.imageHeight / float(newH)
    ...
    def detectTexts(self):
        ...
        return self.drawTextRegions(rects, confidences);
    ...
    def drawTextRegions(self, rects, confidences):
